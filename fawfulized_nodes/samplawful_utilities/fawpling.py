...
from . import fawfulized_utils
from . import fawfulized_deis
...
def to_d(x, sigma, denoised):
    ...
    return (x - denoised) / fawfulized_utils.append_dims(sigma, x.ndim)
...
def sample_deis(model, x, sigmas, extra_args=None, callback=None, disable=None, max_order=3, deis_mode='tab'):
    ...
    coeff_list = fawfulized_deis.get_deis_coeff_list(t_steps, max_order, deis_mode=deis_mode)
