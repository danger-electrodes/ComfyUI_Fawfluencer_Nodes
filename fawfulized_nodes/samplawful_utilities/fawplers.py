...
from . import fawpling as k_diffusion_sampling
from . import fawfulized_uni_pc
...
def sampler_object(name):
    if name == "uni_pc":
        sampler = KSAMPLER(fawfulized_uni_pc.sample_unipc)
    elif name == "uni_pc_bh2":
        sampler = KSAMPLER(fawfulized_uni_pc.sample_unipc_bh2)
    elif name == "ddim":
